...
GO
 ...
 INSERT INTO [dbo].[USUARIO](Documento, NombreCompleto, Correo, Clave, IdRol, Estado, FechaRegistro, PrimerInicioSesion, ClaveCambiada)
VALUES 
('101010', 'ADMIN', 'admin@gmail.com', '123', 1, 1, GETDATE(), 0, 123);

GO

INSERT INTO [dbo].[USUARIO](Documento, NombreCompleto, Correo, Clave, IdRol, Estado, FechaRegistro, PrimerInicioSesion, ClaveCambiada)
VALUES 
('0210', 'ANGEL', 'angel@gmail.com', '0210', 1, 1, GETDATE(), 0, 0210);
...
('p-1010', 'Leche', 'leche para producir y vender', 1, 436, 20.00, 28.00, 1, '2023-08-22 16:09:05.180', 'Litro'),
('p-1011', 'Cuajo', 'producir queso', 2, 78, 40.00, 40.00, 1, '2023-08-22 16:11:08.717', 'Libra'),
('p-1012', 'Cultivo', 'producir queso', 2, 69, 40.00, 40.00, 1, '2023-08-22 16:12:46.757', 'Saco'),
('p-1013', 'Calcio', 'producir queso', 2, 68, 40.00, 40.00, 1, '2023-08-22 16:13:12.197', 'Cubeta'),
('p-1014', 'Catalza', 'producir queso', 2, 67, 40.00, 40.00, 1, '2023-08-22 16:13:25.863', 'Cubeta'),
('p-1015', 'Catibar', 'producir queso', 1, 69, 40.00, 40.00, 1, '2023-08-22 16:14:29.610', 'Cubeta'),
('p-1016', 'Sal', 'producir queso', 2, 77, 250.00, 250.00, 1, '2023-08-22 16:14:54.583', 'Saco'),
('p-1017', 'Colorante', 'producir queso', 2, 68, 40.00, 40.00, 1, '2023-08-22 16:15:24.533', 'Litro'),
('p-1018', 'Peroxido', 'producir queso', 2, 77, 40.00, 40.00, 1, '2023-08-22 16:15:54.870', 'Litro'),
...
GO -- Asegúrate de que esto esté en su propia línea y no haya código SQL antes en el mismo lote.
...
GO -- Es opcional poner 'GO' después del bloque del procedimiento almacenado, pero es una buena práctica para indicar el fin de un lote.
