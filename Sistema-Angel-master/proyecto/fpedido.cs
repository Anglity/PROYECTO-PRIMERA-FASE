...
namespace proyecto
{
    ...
    public partial class fpedido : Form
    {
        ...
        private int CalcularCantidadFaltante(string nombreReceta, int cantidadDeseada)
        {
            cd_producto datosProducto = new cd_producto();
            int stockActual = datosProducto.ObtenerStockActual(nombreReceta);
            int cantidadFaltante = cantidadDeseada - stockActual;
        ...
        public class FechaAleatoria
        {
            public static DateTime GenerarFechaAleatoria()
            {
                ...
                do
                {
                    ...
                    fechaAleatoria = fechaActual.AddDays(rnd.Next(0, 2)); // 7 es exclusivo, generará hasta el 6to día
