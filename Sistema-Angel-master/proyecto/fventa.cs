...
namespace proyecto
{
    ...
    public partial class fventa : Form
    {
        ...
        private void btnagregarproductos_Click(object sender, EventArgs e)
        {
            ...
            if (cbUnidadesMedida.Text == "Bloques de Queso")
            {
                cantidadAComparar = cantidad * 5;
            }
            else if (cbUnidadesMedida.Text == "Galones")
            {
                cantidadAComparar = cantidad * LITROS_POR_GALON;
            }
        ...
        private void calcularTotal()
        {
            ...
            txtitbis.Text = total.ToString("0.00");

            txtitbis2.Text = itbis.ToString("0.00");
...
#pragma warning restore CS0162 // Se detectó código inaccesible
        ...
        {
            if (cbUnidadesMedida.SelectedItem.ToString() == "Bloques de Queso")
            {
            ...
            else // Cuando se selecciona "Libras" o cualquier otra unidad
            {
