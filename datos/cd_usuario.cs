        ...
        public int Registrar(usuario obj, out string Mensaje)
        {
            ...
            try
            {
                using (SqlConnection oconexion = new SqlConnection(conexion.cadena))
                {
                    ...
                    // Asumiendo que el SP puede manejar estos nuevos campos
                    cmd.Parameters.AddWithValue("PrimerInicioSesion", obj.PrimerInicioSesion);
                    // Omitir ClaveCambiada o establecerla según la lógica de negocio
